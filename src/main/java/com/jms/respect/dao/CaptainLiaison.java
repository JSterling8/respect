...
public class CaptainLiaison {
    @Id
    @SequenceGenerator(name = "captain_liaison_id_seq", sequenceName = "captain_liaison_id_seq")
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "captain_liaison_id_seq")
